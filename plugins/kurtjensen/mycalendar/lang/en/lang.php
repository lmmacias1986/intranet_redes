...
return [
	...
	'event' => [ // Event Component and Model
		...
		'error_prohibit' => 'Evento Porhibido!',
		'phold_name' => 'Nombre del evento',
	...
	'rrule' => [ // Rrule Form
		...
		'byday' => 'por día',
		'bymonth' => 'por mes',
		'INTERVALS' => 'Ingrese los días separados por comas',
		'INTERVALS_example' => 'Ejemplo: "1,2,1,4" representaría el evento el primer día, saltar 2 días, otro día del evento 1, saltar 4 días y luego repetir.</p>
        <p>Si su evento se inició el primer día de febrero usando las series de ejemplo anteriores, las fechas del evento serían Febrero 1,4,9,12,17,20,25,28 Marzo 2,5, etc ...',
		...
		'on' => ['on_day' => 'En fecha anterior', 'on_the' => 'En el',
		],
		'day-pos' => [
			'1' => 'Primero',
			'2' => 'Segundo',
